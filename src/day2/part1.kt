...
fun runCommands(input: Array<Int>) {
    var index = 0
...
fun multiply(input: Array<Int>, offSet: Int) {
    input[input[offSet + ASSISTS.THIRD_POS.assistId]] = input[input[offSet + ASSISTS.FIRST_POS.assistId]] * input[input[offSet + ASSISTS.SECOND_POS.assistId]]
}
